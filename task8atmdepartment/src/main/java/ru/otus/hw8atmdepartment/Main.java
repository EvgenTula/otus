package ru.otus.hw8atmdepartment;/*
Сейчас уже лучше.
Задание принято.

public interface IObserver {
    void register(ru.otus.hw8atmdepartment.atm atm);
    void unregister(ru.otus.hw8atmdepartment.atm atm);
...
Result<T> doCommand(ru.otus.hw8atmdepartment.atm atm);
}
```
это уже супер будет.
*/
...
import ru.otus.hw8atmdepartment.department.*;
